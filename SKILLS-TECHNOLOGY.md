# Skills & Technology — Expanded Matrix
...
| Signal processing | Advanced | *Alpha Pi Project* — 7-chapter monograph: cardiac signal processing → quantum state readout |
...
| National-scale statistical modeling | Expert | Tour-Based Model System (FHWA) — agent-based simulation of U.S. long-distance travel |
| Geospatial analytics (GIS) | Expert | GIS Analyst (2004–2005) → national-scale spatial data integration (AARP, FHWA) |
...
| Emergence & feedback analysis | Expert | *The Re-Entry Thesis* — structural invariant across self-referential paradoxes |
...
| Information theory | Expert | *The Information Spectrum* (book), adelic information measures |
| Signal processing | Advanced | *Alpha Pi Project*, cardiac → quantum signal translation |
